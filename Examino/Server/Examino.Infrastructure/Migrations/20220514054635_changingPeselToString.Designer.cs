...
namespace Examino.Infrastructure.Migrations
{
    ...
    [Migration("20220514054635_changingPeselToString")]
    partial class changingPeselToString
    {
            ...
            modelBuilder.Entity("Examino.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Kraków",
                            ConcurrencyStamp = "c51ccbc5-bb54-4b23-a7dd-e121c746f9b2",
                            ...
                            PESEL = "99101912345",
                            PasswordHash = "AQAAAAEAACcQAAAAEIOsHxJsz8H91GU1zYALgyP07cTLmBYsXOSQwIigxhFUxR974kxyklu0PFnZhiPbxA==",
                            PhoneNumber = "999111222",
                            PhoneNumberConfirmed = true,
                            PostalCode = "30-004",
                            SecurityStamp = "c3e30320-9336-43a6-b91f-43f0eca3d03e",
                            Surname = "Kowalski",
            ...
            modelBuilder.Entity("Examino.Domain.Entities.Raport", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RaportTime = new DateTimeOffset(new DateTime(2022, 5, 14, 7, 46, 34, 864, DateTimeKind.Unspecified).AddTicks(129), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            RaportTime = new DateTimeOffset(new DateTime(2022, 5, 14, 7, 46, 34, 864, DateTimeKind.Unspecified).AddTicks(192), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            PatientId = new Guid("4d9b6996-8e8a-4cec-9f2f-d7f64e2113ca"),
                            RaportTime = new DateTimeOffset(new DateTime(2022, 5, 14, 7, 46, 34, 864, DateTimeKind.Unspecified).AddTicks(200), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            RaportTime = new DateTimeOffset(new DateTime(2022, 5, 14, 7, 46, 34, 864, DateTimeKind.Unspecified).AddTicks(206), new TimeSpan(0, 2, 0, 0, 0)),
            ...
            modelBuilder.Entity("Examino.Domain.Entities.Doctor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Kraków",
                            ConcurrencyStamp = "85065441-56b1-42ae-bcff-105aa2e81ea9",
                            ...
                            PESEL = "66030280889",
                            PasswordHash = "AQAAAAEAACcQAAAAEAfi5uPTDE4cLEenAyNeZPS7jzAWM33hniFm08u5NY9y7Oy84S9VNanSevFAl4P+uQ==",
                            PhoneNumber = "999321933",
                            PhoneNumberConfirmed = true,
                            PostalCode = "30-001",
                            SecurityStamp = "063346bf-a96a-4095-ae04-17864db27fe6",
                            Surname = "Majewski",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            City = "Kraków",
                            ConcurrencyStamp = "b0b537e0-ff5d-4eb9-abfe-58082308a0c8",
                            ...
                            PESEL = "60070111229",
                            PasswordHash = "AQAAAAEAACcQAAAAEJSNZklf2zoJlTGtgdhESrGYVxtmwaGa1XxKwlz38K2KrMCDFE1NApkh6lWu32TPog==",
                            PhoneNumber = "129888777",
                            PhoneNumberConfirmed = true,
                            PostalCode = "30-003",
                            SecurityStamp = "63eab17a-6915-422d-b4df-998c31943309",
                            Surname = "Gwinciarz",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Examino.Domain.Entities.Patient", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            City = "Jeleśnia",
                            ConcurrencyStamp = "836a9c03-4f5e-4d4e-9f4a-a94981cd60fe",
                            ...
                            PESEL = "78032180802",
                            PasswordHash = "AQAAAAEAACcQAAAAEF0vo6RVfMFeMRGjmYGXA+P6AzOALg8T++KBfHez8K6iA2wz4TbJIzKDrd+93bO1dw==",
                            PhoneNumber = "999111333",
                            PhoneNumberConfirmed = true,
                            PostalCode = "34-331",
                            SecurityStamp = "09d31b20-53af-4bb0-ab2b-f8826758cab6",
                            Surname = "Skrzypek",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            City = "Gdańsk",
                            ConcurrencyStamp = "d8216bd4-4d78-4b46-88f0-9803342821f7",
                            ...
                            PESEL = "90042182882",
                            PasswordHash = "AQAAAAEAACcQAAAAEBXqyFHvR7MFiu9BOzWwKTZSgEFjJM2GzzYTIZYt8yiOP2ETJhItTU4j7Gaz7Le0pg==",
                            PhoneNumber = "999888777",
                            PhoneNumberConfirmed = true,
                            PostalCode = "80-001",
                            SecurityStamp = "b08916cd-fb23-4919-b136-23dcb0484f03",
                            Surname = "Gwizd",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            City = "Zakopane",
                            ConcurrencyStamp = "1239327d-a230-4402-967b-56b133986a19",
                            ...
                            PESEL = "99042382888",
                            PasswordHash = "AQAAAAEAACcQAAAAEAuZdYiNQXykwf6DCR+Z1YkdsTJR6yksPmh4CAc+LjhJVe0yRLWS2fZHXLleMKtbBQ==",
                            PhoneNumber = "992488111",
                            PhoneNumberConfirmed = true,
                            PostalCode = "34-500",
                            SecurityStamp = "f7e982f9-24d6-4ad9-b285-86ae03723238",
                            Surname = "Kwiatowski",
                            TwoFactorEnabled = false,
